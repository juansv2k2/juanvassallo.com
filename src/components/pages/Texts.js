            ...
            <ul>
              <li>
                <p>
                  ...
                  Constraint-Based Composition. Embodied Perspectives on Sound
                  and Music AI. Frontiers in Computer Sciences, 7.
                </p>
                <p className="link">
                  <a
                    className="link"
              ...
              <li>
                <p>
                  ...
                  Computational Influence on Compositional Frameworks and
                  Methods in the piece "Elevator Pitch". International Journal
                  of Music Science, Technology and Art. 6, 1-16.
                </p>
                <p className="link">
                  <a
                    className="link"
            ...
            <ul>
              <li>
                <p>
                  ...
                  text and music composition: The versificator. Proceedings of
                  the 7th Colloquium on Artistic Research in Performing Arts
                  (CARPA7).
                </p>
                <p>
                  <a
            ...
            <ul>
              <li>
                <p>
                  ...
                  speech perception. University of Victoria Repository Dspace.
                </p>
                <p>
                  <a
                    className="link"
