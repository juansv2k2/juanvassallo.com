      ...
      <div className="secondaryWrapper">
        ...
        <div class="row">
          <div className="leftSide">
            <div className="cv">
              <h2>Field of artistic practice</h2>
              <ul>
                <li>
                  Composer of instrumental and electronic music. Performer of
                  live electronics.
                </li>
                <li>
                ...
                <li>
                  Pianist with experience in diverse classical and popular
                  genres.
                </li>
              </ul>
              <h2>Academic and artistic research interests</h2>
              <ul>
                <li>
                  Applications of artificial intelligence in art creation.
                </li>
                <li>
                ...
                <li>
                  Sonification/visualization of speech and sonic data for
                  artistic applications; sonification of body signals
                  (biofeedback).
                </li>
              </ul>
              ...
              <h2>Additional relevant training</h2>
              <ul>
                <li>
                ...
                <li>
                  2021 – Certificate in Full-Stack Web Development– Digital
                  House Coding School. Buenos Aires, Argentina; (420 hs., 7
                  months)
                </li>
                <li>
              ...
              <h2>Teaching experience (at tertiary level)</h2>
              <ul>
                <li>
                  2020-2025 – The Grieg Academy, Faculty of Music, Art and
                  Design (KMD), University of Bergen (UiB), Norway. Individual
              ...
              <h2>Non-academic job positions</h2>
              <ul>
                <li>
              ...
              <ul>
                <li>
                  2025 – Music Norway – Travel grant for ICMC 2025 (Boston,
                  USA).
                </li>
                <li>
                ...
                <li>
                  2023 – Norsk Komponistforening (NKF) – Grant for the
                  publication of the composition I am a Strange Loop.
                </li>
                <li>
                  2022 – Morten Eide Pedersen Minnefond – Project Versificator,
                  in collaboration with ensemble Tabula Rasa (Bergen).
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  Member: NOPA (Norwegian Society of Composers and Writers)
                </li>
